...
def main(num, dataset, cfg, savename):
    ...
    parser.add_argument('--tracker_name', type=str, default='fermt', help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default=cfg, help='Name of config file.')
    parser.add_argument('--save_name', type=str, default='mctrack-' + str(num), help='Name of save file.')
    parser.add_argument('--runid', type=int, default=None, help='The run id.')
    parser.add_argument('--dataset_name', type=str, default=dataset,
                        help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot).')
    parser.add_argument('--sequence', type=str, default='dog-19', help='Sequence number or name.')
...
if __name__ == '__main__':
    cfg = 'vit_tiny_ep300'
    datasets = ['lasot']  # 'got10k'
    epochs = [300]
    for num in epochs:
        epoch = num
        savename = 'mctrack_ep' + str(epoch)
