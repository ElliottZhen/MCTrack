...
def transform_trackingnet(tracker_name, cfg_name):
    ...
    src_dir = os.path.join(result_dir, "%s/%s/trackingnet/fermt-299/trackingnet/" % (tracker_name, cfg_name))
    dest_dir = os.path.join(result_dir, "%s/%s/trackingnet/fermt-299/trackingnet_submit/" % (tracker_name, cfg_name))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--cfg_name', default='fast_itpns_256_clip_ep150', type=str, help='Name of config file.')
