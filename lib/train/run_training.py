...
def main():
    ...
    parser.add_argument('--script', type=str, default='FERMT', help='Name of the train script.')
    parser.add_argument('--config', type=str, default='', help="Name of the config file.")
    ...
    parser.add_argument('--seed', type=int, default=42, help='seed for ra ndom numbers')
