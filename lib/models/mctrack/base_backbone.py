...
from lib.models.mctrack.utils import combine_tokens, recover_tokens
from lib.models.layers.MCM.mcm import MCM
...
class BaseBackbone(nn.Module):
    def __init__(self):
        ...
        self.n_layers = 1
        self.d_state = 16
        self.mcm = MCM(topk=self.topk_num, win_size=self.win_size, dim=self.dim , nlayer=self.n_layers, state=self.d_state)
    ...
    def forward_features(self, z, x, hidden_state=None):
        ...
        x, hidden_state = self.mcm(z, x, hidden_state)
        ...
        return self.norm(x), hidden_state, aux_dict

    def forward(self, z, x, hidden_state, **kwargs):
        """
        ...
        Returns:
            ...
            attn : None
        """
        x, hidden_state, aux_dict = self.forward_features(z, x, hidden_state,)

        return x, hidden_state, aux_dict