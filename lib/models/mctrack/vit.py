...
from lib.models.mctrack.base_backbone import BaseBackbone
            ...
            for k, v in checkpoint.items():
                if "module.model." in k:
                    ...
                    if "fc_norm" in key:
                        key = key[3:]
                    save_check[key] = v
            missing_keys, unexpected_keys = model.load_state_dict(save_check, strict=False)
...
def vit_tiny_patch16_224(pretrained=False, **kwargs):
    ...
    model = _create_vision_transformer('vit_tiny_patch16_224_ft', pretrained=pretrained, **model_kwargs)
    return model