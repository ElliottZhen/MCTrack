...
class CenterPredictor(nn.Module, ):
    def __init__(self, inplanes=64, channel=256, feat_sz=20, stride=16, freeze_bn=False):
        ...
        # self.conv1_size = attn(inplanes, channel)
        # self.conv2_size = attn(channel, channel // 2)
        # self.conv3_size = attn(channel // 2, channel // 4)
        # self.conv4_size = attn(channel // 4, channel // 8)
        # self.conv5_size = nn.Conv2d(channel // 8, 2, kernel_size=1)
